  ...
  if (isSerialAvailable) {
    if (isFirstScreen) {
      ...
      if (timeRemaining > 0) {
        ...
        text("Participant ID: " + participantID, width / 2 - 30, height / 1.1);
        text("Code: " + buttonPressed, width / 2 + 150, height / 1.1);
        line(width / 2 - 200, height - 150, width / 2 + 200, height - 150);
        line(width / 2 - 200, height - 150, width / 2 - 200, -targetSize / 2 + 100);
        line(width / 2 + 200, height - 150, width / 2 + 200, -targetSize / 2 + 100);
        stroke(20);
        ...
        if (gameActive) {
          ...
          // Commenting 2 lines below to make the player not visible
          fill(playerColor);
